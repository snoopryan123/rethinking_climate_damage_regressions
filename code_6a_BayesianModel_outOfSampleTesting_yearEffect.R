...
### Usage:  Rscript code_6_... 15 19    # runs year indices 15-19
###         Rscript code_6_... 20 24    # runs year indices 20-24
###         Rscript code_6_...          # runs all (15:34)
#####################
...
for (max_training_year_idx in MAX_TRAINING_YR_VEC) {
  ...
  csv_path <- paste0("results/results_bayesianOutOfSampleTest", max_training_year_idx, ".csv")
